...
?>
<div class="grid__item grid__item-two mb-3 <?php echo 'post_' . esc_attr($post_format); ?>">
    <div class="post-masonry-two__item--inner border-default">
        ...
        <div class="post-masonry-two__content">
            <?php megan_minimal_lightweight_blog_entry_options($post, array('class' => 'mb-2', 'entry_date' => $entry_masonry_two_date, 'entry_cat' => $entry_masonry_two_category, 'entry_author' => $entry_masonry_two_author, 'entry_read_time' => $entry_masonry_two_read_time, 'entry_comment' => $entry_masonry_two_comment, 'entry_view_count' => $entry_masonry_two_view)); ?>
            <h3 class="post-masonry-two__title"><a href="<?php echo esc_html($get_permalink); ?>"><?php echo get_the_title() ?></a></h3>
            <div class="post-masonry-two__sub">
